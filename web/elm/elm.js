...
Elm.Actions.make = function (_elm) {
   ...
   var NoOp = {ctor: "NoOp"};
   return _elm.Actions.values = {_op: _op,NoOp: NoOp,UpdateTicker: UpdateTicker};
};
...
Elm.Models.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var initialModel = {ticker: "NYC"};
   var AppModel = function (a) {    return {ticker: a};};
...
Elm.View.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var tickerTable = F2(function (address,model) {    return A2($Html.p,_U.list([]),_U.list([$Html.text(model.ticker)]));});
   var brandLink = F2(function (address,model) {
      return A2($Html.a,_U.list([$Html$Attributes.href("#"),$Html$Attributes.$class("navbar-brand")]),_U.list([$Html.text("Stackfooter")]));
   });
   var navbar = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("navbar-header")]),_U.list([A2(brandLink,address,model)]))]))]));
   });
   var page = F2(function (address,model) {    return A2($Html.div,_U.list([]),_U.list([A2(navbar,address,model),A2(tickerTable,address,model)]));});
   var view = F2(function (address,model) {    return A2($Html.div,_U.list([]),_U.list([A2(page,address,model)]));});
   var ViewModel = function (a) {    return {ticker: a};};
   return _elm.View.values = {_op: _op,ViewModel: ViewModel,view: view,page: page,navbar: navbar,brandLink: brandLink,tickerTable: tickerTable};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "UpdateTicker") {
            return {ctor: "_Tuple2",_0: _U.update(model,{ticker: _p0._0}),_1: $Effects.none};
         } else {
            return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         }
   });
   var app = $StartApp.start({init: init,inputs: _U.list([]),view: $View.view,update: update});
   var main = app.html;
   return _elm.Main.values = {_op: _op,update: update,init: init,app: app,main: main};
};
